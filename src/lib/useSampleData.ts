// ─────────────────────────────────────────────────────────────────────
// Sample data seeder — populates IndexedDB with demo records on first
// visit so the workflow pages are immediately useful.
//
// Migrated and simplified from smart/browser/src/composables/
// useUpgradeSampleData.ts (263 lines → ~120 lines).
//
// Seeds: 1 family, 3 groups, 5 models, 2 samples, 1 application,
// 1 TestRequest, 2 organizations (IA + Lab), 1 EvaluationReport.
//
// Gated by localStorage flag so it runs once per browser.
// ─────────────────────────────────────────────────────────────────────
...
async function seed(): Promise<void> {
  ...
  // ── 5 Models (simplified from Annex D's 14) ───────────────────
