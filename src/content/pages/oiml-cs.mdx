...
<p>
  <img src="/img/brand/cs-light.svg" alt="OIML-CS" class="cs-logo-light h-10" />
  <img src="/img/brand/cs-dark.svg" alt="OIML-CS" class="cs-logo-dark h-10" />
</p>
...
*Each IA is registered with its Member State code and a serial number, and its Declaration defines the categories and schemes it may issue under.*
