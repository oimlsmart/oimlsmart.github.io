...
<div class="rec-grid">
  <a class="rec-card" href="/recs/r60">
  ...
  <a class="rec-card" href="/recs/r129">
  ...
  <a class="rec-card" href="/recs/r144">
...
the `oimlsmart/smart` application repository (private during the pilot, the public entry points are [the app](/app/) and [the docs federation](https://primmel.github.io/primmel-smart-docs/)).
