...
the `oimlsmart/smart` application repository (private during the pilot, the public entry points are [the app](https://demo.oimlsmart.org/) and [the docs federation](https://www.primmel.org/primmel-smart-docs/)).
