---
title: 'OIML R 144: Diaphragm gas meters'
description: 'Diaphragm gas meters are the workhorses of residential and commercial gas metering, measuring fuel gas consumption for billing. R 144 specifies the metrological requirements that ensure those measurements are accurate and auditable.'
eyebrow: 'Recommendation · R 144 · 2006'
---
...
- [Browse R 144 as a structured document in the SMART Recommendations browser ↗](https://www.oimlsmart.org/recs/)
- [Read the source document in the Library](/library/r144)

## Certification path

Certification of diaphragm gas meters follows the standard
[workflow](/use-cases/type-evaluation-end-to-end). Manufacturers typically submit
