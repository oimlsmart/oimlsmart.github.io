...
These four Recommendations have been modelled in the SMART platform.
...
| [**R 91**](/library/r91) | Traffic speed meters | 2025 | Modelled (preview) |
...
requirements, run conformance tests, fill forms), use the [demo instance ↗](https://demo.oimlsmart.org/).

For **developer documentation** about how SMART Recommendations are structured
and authored, see the [Developer guides](https://www.oimlsmart.org/studio/docs/guides/getting-started).
