...
Calculations are written in the embedded expression language (AsciiMath for arithmetic, OCL for boolean conditions), see the [requirements authoring guide](https://www.oimlsmart.org/recs/docs/oiml-rec/03-requirements).
...
Every step is captured as structured data with full traceability from certificate back to the originating requirement. Read the [end-to-end type evaluation](/use-cases/type-evaluation-end-to-end) for the full picture.
