...
- [Developer guide, Identity & Dimensions](https://www.oimlsmart.org/studio/docs/guides/identity-dimensions)
- [Developer guide, Provision Data Model](https://www.oimlsmart.org/studio/docs/guides/provision-data-model)
