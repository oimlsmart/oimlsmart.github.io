...
The platform includes an interactive ontology browser that
visualizes the class hierarchy, shows instances, and lets users run
semantic queries. The browser runs on this site under
[/ontology/](/ontology/), no sign-in required.
...
See the [authoring method](https://www.oimlsmart.org/recs/docs/oiml-rec/01-methodology)
for the authoring workflow.

## Cross-references

- [Technology overview](/about/technology), Primmel, Metanorma, Relaton, LutaML.
- [The architecture chapters](/docs/arch/), how the ontology fits the platform's model.
- [Modelling the subject](https://www.oimlsmart.org/recs/docs/oiml-rec/02-modelling-the-subject), terms and cross-refs.
