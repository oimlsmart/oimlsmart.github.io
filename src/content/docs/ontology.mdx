...
See the developer guide on [Ontology Architecture](https://www.oimlsmart.org/studio/docs/guides/ontology)
...
- [Terminology guide](https://www.oimlsmart.org/studio/docs/guides/terminology), terms and cross-refs.
