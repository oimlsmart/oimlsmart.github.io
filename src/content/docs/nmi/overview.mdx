---
title: 'For Legal-Metrology Authorities'
shortTitle: 'Overview'
description: 'The program in legal-metrology language: traceability, uncertainty, and why this tooling is yours.'
eyebrow: 'For NMIs · Volume overview'
order: 0
---
...
3. **Can we reproduce it?** The whole stack stands up from a checkout
   ...
   commands you will run ([the authority quickstart](/docs/nmi/01-authority-quickstart)).
...
*Next: [the authority quickstart](/docs/nmi/01-authority-quickstart), stand
