---
title: 'The Authority Quickstart'
shortTitle: 'The Authority Quickstart'
description: 'A runbook for a legal-metrology authority: stand up the OIML SMART stack and reproduce a full type evaluation end to end.'
eyebrow: 'For NMIs · 01 of 01'
order: 1
---
...
*Next: [the member-state narrative](/docs/nmi/#4-the-member-state-narrative)
in the position pack, or [the demo manual](https://www.oimlsmart.org/recs/docs/oiml-rec/13-running-the-demo)
