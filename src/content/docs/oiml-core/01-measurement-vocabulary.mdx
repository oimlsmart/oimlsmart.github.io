...
shortTitle: 'Measurement Vocabulary'
description: 'Module A: QuantityKind, Unit, QuantityValue, uncertainty, Measurand, InfluenceQuantity, Conditions, MeasurementResult, TraceabilityChain.'
eyebrow: 'OIML Core · 01 of 10'
order: 1
---
...
*Next: [Chapter 2, The Subject Chain](/docs/oiml-core/02-subject-chain): Family →
