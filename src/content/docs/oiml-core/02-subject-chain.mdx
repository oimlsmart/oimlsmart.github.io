---
title: 'The Subject Chain'
shortTitle: 'The Subject Chain'
description: 'Module C core: Family → Group → Model → Sample; VIML anchoring; classification; scope and origin; delegation.'
eyebrow: 'OIML Core · 02 of 10'
order: 2
---
...
*Next: [Chapter 3, Instrument Aspects](/docs/oiml-core/03-instrument-aspects): the
