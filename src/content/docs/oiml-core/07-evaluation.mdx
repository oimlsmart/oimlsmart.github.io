...
description: 'Module D3: SampleEvaluation, Verdict, TypeEvaluation, EvaluationReport, TypeApprovalDecision.'
eyebrow: 'OIML Core · 07 of 10'
order: 7
---
...
*Next: [Chapter 8 — Parties and Workflow](/docs/oiml-core/08-parties-and-workflow): who
