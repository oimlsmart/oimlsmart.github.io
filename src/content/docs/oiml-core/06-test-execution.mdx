...
description: 'Module D2: TestRun, EvidenceRecord, admissibility, ConstraintCheck, TestReport.'
eyebrow: 'OIML Core · 06 of 10'
order: 6
---
...
test_run run-2026-0142 {
  ...
  lab            lab:example-tl-2
  operator       "J. Verger"
  started        2026-03-11T09:20:00Z
  equipment      [{ id: "force-machine-2", cal_cert: "ETL-2025-118" }]
...
*Next: [Chapter 7, Evaluation](/docs/oiml-core/07-evaluation): Module D3, judgments
