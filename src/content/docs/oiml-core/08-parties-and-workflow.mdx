---
title: 'Parties and Workflow'
shortTitle: 'Parties and Workflow'
description: 'Parties, roles, the certification workflow entities, lifecycle state machines.'
eyebrow: 'OIML Core · 08 of 10'
order: 8
---
...
*Next: [Chapter 9, Invariants](/docs/oiml-core/09-invariants): INV-1..10 and beyond , 
