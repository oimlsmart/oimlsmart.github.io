---
title: 'Invariants'
shortTitle: 'Invariants'
description: 'INV-1..14: the metamodel’s laws, each with rationale, checks, and the shipped registry’s crosswalk.'
eyebrow: 'OIML Core · 09 of 10'
order: 9
---
...
*Next: [Chapter 10 — Shared modules](/docs/oiml-core/10-shared-modules): the seven
