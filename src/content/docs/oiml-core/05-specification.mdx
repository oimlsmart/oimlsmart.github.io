...
description: 'Module D1: Recommendation, Requirement, ConformanceTest, TestMethod, TestStep.'
eyebrow: 'OIML Core · 05 of 10'
order: 5
---
...
*Next: [Chapter 6 — Test Execution](/docs/oiml-core/06-test-execution): Module D2 —
