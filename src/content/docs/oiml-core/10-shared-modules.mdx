...
shortTitle: 'Shared Modules'
description: 'emc-disturbances, env-iec60068, software-d31, reference-materials, specimen-governance, report-headers, examination-docs.'
eyebrow: 'OIML Core · 10 of 10'
order: 10
---
...
*Next: [Volume III, Authoring OIML Recommendations](https://www.oimlsmart.org/recs/docs/):
