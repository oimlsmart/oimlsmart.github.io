---
title: 'Instrument Aspects'
shortTitle: 'Instrument Aspects'
description: 'Module C aspects: attributes/parameters, capabilities, behaviors, condition sets, formulas, constraints.'
eyebrow: 'OIML Core · 03 of 10'
order: 3
---
...
*Next: [Chapter 4, Identity and Provenance](/docs/oiml-core/04-identity-and-provenance):
