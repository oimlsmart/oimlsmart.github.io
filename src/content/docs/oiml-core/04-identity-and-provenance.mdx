...
shortTitle: 'Identity and Provenance'
description: 'Module B: Manufacturer, SoftwareComponent, Marking, Sealing, CalibrationRecord, Certificate.'
eyebrow: 'OIML Core · 04 of 10'
order: 4
---
...
calibration_record for sample SN_0042 {
  date 2026-03-14   lab "Example Test Laboratory 1.12"   certificate "ETL-26-11843"
...
*Next: [Chapter 5, Specification](/docs/oiml-core/05-specification): Module D1 , 
