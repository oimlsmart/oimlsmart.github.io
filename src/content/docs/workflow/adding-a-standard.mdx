...
The schemas and generated types this guide references belonged to the platform's first, YAML-based design and are superseded with [the SMART_REQS set](/docs/specifications); the current design authors every normative model as a Primmel package, defined by the [Primmel language specification](https://www.primmel.org).
