---
title: 'The CASCO Foundation'
shortTitle: 'The CASCO Foundation'
description: 'Delegation to ISO/IEC 17000/17065/17025/17067, and the facet trio that makes it machine-checkable.'
eyebrow: 'OIML-CS · 02 of 08'
order: 2
---
...
## 2.3 `activity_kind`: the kind of activity
...
## 2.4 `segregation:`: the hands that must stay off this case
...
effective tree contains one copy of each register, and every
...
*Next: [Chapter 3, The documents corpus](/docs/oiml-cs/03-documents-corpus): the
