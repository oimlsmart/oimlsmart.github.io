---
title: 'The Coverage Machinery'
shortTitle: 'The Coverage Machinery'
description: 'The .prm maps, the unified per-document report, the named-gap doctrine, the mutation proofs.'
eyebrow: 'OIML-CS · 07 of 08'
order: 7
---
...
*Next: [Chapter 1, The scheme architecture](/docs/oiml-cs/01-scheme-architecture)
,  or back to the [volume overview](/docs/oiml-cs/) for the chapter map.*
