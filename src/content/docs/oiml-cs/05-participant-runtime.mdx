---
title: 'The Participant Runtime'
shortTitle: 'The Participant Runtime'
description: 'The registry, the approval pipeline with the MC 80 % vote, the issuance gate that fails closed.'
eyebrow: 'OIML-CS · 05 of 08'
order: 5
---
...
*Next: [Chapter 6 — The operations runtime](/docs/oiml-cs/06-operations-runtime):
