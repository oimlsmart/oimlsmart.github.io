---
title: 'The Scheme Architecture'
shortTitle: 'The Scheme Architecture'
description: 'The B 18:2025 constitution: participant kinds and organs, Schemes A and B, Declarations, the document hierarchy, governance rules.'
eyebrow: 'OIML-CS · 01 of 08'
order: 1
---
...
*Next: [Chapter 2, The CASCO foundation](/docs/oiml-cs/02-casco-foundation): why
