---
title: 'The Certification Workflow'
shortTitle: 'The Certification Workflow'
description: 'PD-05 as abstract processes + 34 provisions, realized_by binding, the .prm coverage discipline.'
eyebrow: 'OIML-CS · 04 of 08'
order: 4
---
...
*Next: [Chapter 5, The participant runtime](/docs/oiml-cs/05-participant-runtime):
