...
const EXTERNAL_HREFS = new Set(['/vocab/', '/resolutions/', '/publications/', '/vocab', '/publications', '/resolutions', '/recs', '/studio', '/smi', '/sst', '/cnml', '/concepts-management/', '/login/', '/vocabularies/'])
