...
<div class="page-hero">
  <span class="eyebrow">Recommendation · R 60 · 2021</span>
  <h1>OIML R 60: Metrological regulation for load cells</h1>
  <p class="lede">
    The pilot SMART Recommendation. Load cells are the most widely deployed
    measuring instruments in legal metrology, used in every nonautomatic
    weighing instrument from retail scales to vehicle weighbridges.
  </p>
</div>
...
- [Browse R 60 requirements, tests, and forms in the app ↗](https://app.oimlsmart.org)
